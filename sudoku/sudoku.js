...
function toggleNotesMode() {
  ...
  DOM.notesLabel.textContent = state.notesMode ? 'Notes ✓' : 'Notes';
}
...
function showWin() {
  ...
  DOM.winBestTime.textContent = isNewBest ? '🏆 New best time!' : '';
